...
import { StyleSheet, Text, View, Image, Button, ScrollView, RefreshControl, DrawerLayoutAndroid, TextInput, TouchableOpacity, } from "react-native"
        ...
        <DrawerLayoutAndroid
          ...
          <NavigationContainer>
            ...
            <Tab.Navigator
              ...
              <Tab.Screen name="Pharmacys" component={Pharmacys}
                options={{
                  tabBarLabel: '',
                  tabBarIcon: () => (
                    <>
